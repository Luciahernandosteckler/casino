...
function mostrarMenu(jugador: Jugador) {
    let opcion: number;
...
function identificarse(jugador: Jugador) {
    try {
...
function cargarSaldo(jugador: Jugador) {
    try {
...
function retirarDinero(jugador: Jugador) {
    try {
...
function seleccionarJuego(jugador: Jugador) {
    try {
        console.log('\n--- Juegos Disponibles ---');
